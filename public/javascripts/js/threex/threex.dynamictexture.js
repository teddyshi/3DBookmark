...
THREEx.DynamicTexture	= function(width, height){
	...
	canvas.id		= 'dynamicTextureCanvas'
	canvas.class	= 'textureCanvas'
	canvas.width	= width
...
THREEx.DynamicTexture.prototype.drawTextCooked = function(text, options){
	...
	var params	= {
		...
		lineHeight	: options.lineHeight !== undefined ? options.lineHeight : 0.01,
		align		: options.align !== undefined ? options.align : 'left',
		fillStyle	: options.fillStyle !== undefined ? options.fillStyle : 'red',
		contextFont : options.contextFont !== undefined ? options.contextFont : 'small-caps 10px arial'
	};
	context.font = params.contextFont;
	context.save();
